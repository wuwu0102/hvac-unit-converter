...
function initFeedbackTool(){
  ...
  const FORMAL_GOOGLE_FORM_URL =
    'https://docs.google.com/forms/d/e/1FAIpQLSc95R0vPbKHLP9kP4MkCxsTVxk0aHTw4iCqlEHNb-Aa6RSWNQ/viewform';
  ...
  if (emailButton) {
    emailButton.addEventListener('click', () => {
      ...
      window.location.href =
        `mailto:chttwm@gmail.com?subject=${subject}&body=${body}`;
    });
  }
}
...
const toolRegistry = {
  ...
  render:()=>`
    <div class='result-box'>
      ...
      <p class='muted'>
        提醒：若要回報畫面問題，請附上截圖與操作步驟，會更快協助排查。
      </p>
    </div>
  `,
